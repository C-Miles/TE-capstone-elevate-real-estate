...
START TRANSACTION;
INSERT INTO payment_details (payment_details_id, username, unit_id, credit_card, expiration_date, cvc, amount, payment_approved) VALUES (default, 'username', 1, 12345678, '04/25', 313, 2000, true) RETURNING payment_details_id;
