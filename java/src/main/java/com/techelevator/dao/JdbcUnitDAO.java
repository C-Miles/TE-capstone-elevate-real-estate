...
public class JdbcUnitDAO implements UnitDAO{
    ...
    public List<Unit> getAllUnitsByPropertyId(long propertyId) throws PropertyNotFoundException {
        ...
        String sql = "SELECT property_name, unit_id, image_names, rooms, monthly_rent, apartment_number, unit.address_id, unit.property_id AS property_id FROM unit " +
    ...
    private Unit mapRowToProperty(SqlRowSet rows) {
        ...
        unit.setImageName(rows.getString("image_names"));
